        ...
        if ($this->program_contract_type == "Mensual") {
          ...
          if (Auth::user()->organizationalUnit->establishment_id == 38) {
            ...
            if (Auth::user()->organizationalUnit->id == 24) {
              ...
              $this->signatureFlows['S.D.G.A'] = 14104369; // 2 - Subdirección de Gestion Asistencial / Subdirección Médica
              $this->signatureFlows['Planificación CG RRHH'] = 14112543; // 59 - Planificación y Control de Gestión de Recursos Humanos
              $this->signatureFlows['S.G.D.P'] = 15685508; // 44 - Subdirección de Gestión y Desarrollo de las Personas
              $this->signatureFlows['S.D.A'] = 9994426; // 31 - Subdirección de Recursos Físicos y Financieros
              $this->signatureFlows['Director'] = 9381231; // 1 - Dirección
            }
