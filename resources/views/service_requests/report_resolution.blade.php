  ...
  <div class="content">
    ...
    <div class="content">
      ...
      <p class="justify">
        ...
        @if($ServiceRequest->responsabilityCenter->establishment_id == 1)
        Don {{App\Rrhh\Authority::getAuthorityFromDate(1,now(),['manager'])->user->FullNameUpper}}, en su calidad de {{App\Rrhh\Authority::getAuthorityFromDate(1,now(),['manager'])->position}} del Hospital “Dr. Ernesto Torres Galdames” de Iquique, contrata a {{$ServiceRequest->employee->getFullNameAttribute()}}, ({{$ServiceRequest->profession->name}} - {{$ServiceRequest->working_day_type}}), para que preste servicios en el {{$ServiceRequest->responsabilityCenter->name}} del Hospital de Iquique bajo la modalidad de Honorarios a Suma Alzada.
        @else
      ...
      @else
      <p class="justify">
        <strong>DÉCIMO PRIMERO:</strong> La personería de D.{{App\Rrhh\Authority::getAuthorityFromDate(1,now(),['manager'])->user->FullNameUpper}} , para representar al Hospital “Dr. E. Torres G.” de Iquique, en su calidad de {{App\Rrhh\Authority::getAuthorityFromDate(1,now(),['manager'])->position}}, consta en
        {{App\Rrhh\Authority::getAuthorityFromDate(1,now(),['manager'])->decree}},
      ...
      <p class="justify">
        ...
        @if($ServiceRequest->responsabilityCenter->establishment_id == 1)
        La personería de D.{{App\Rrhh\Authority::getAuthorityFromDate(1,now(),['manager'])->user->FullNameUpper}}, para representar al Hospital “Dr. E. Torres G.” de Iquique, en su calidad de {{App\Rrhh\Authority::getAuthorityFromDate(1,now(),['manager'])->position}}, consta en
        {{App\Rrhh\Authority::getAuthorityFromDate(1,now(),['manager'])->decree}},
        del Servicio de Salud Iquique.
        @else
