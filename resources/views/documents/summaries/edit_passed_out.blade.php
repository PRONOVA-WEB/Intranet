...
<!-- <form method="post" name="form" action="{{ route('documents.store') }}" onsubmit="return validate_form()">
    ...
    <div class="form-row">
        <div class="form-group col-lg-2">
            ...
            <input type="text" class="form-control" id="forNumber" name="number" value="2" disabled>
        </div>
        <div class="form-group col-lg-2">
            <label for="forNumber">Nro Resolución</label>
            <input type="text" class="form-control" id="forNumber" name="number" value="4848" disabled>
        </div>
        <div class="form-group col-lg-2">
