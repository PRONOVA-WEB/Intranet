    ...
    <form method="GET" class="form-horizontal" action="{{ route('pharmacies.reports.informe_movimientos') }}">
        ...
        <div class="input-group mb-3">
            ...
            <input type="date" class="form-control" id="for_dateFrom" name="dateFrom"
                value="{{ $request->get('dateFrom') ? $request->get('dateFrom') : date('Y-m-01') }}" required>
            <input type="date" class="form-control" id="for_dateTo" name="dateTo"
                value="{{ $request->get('dateTo') ? $request->get('dateTo') : date('Y-m-t') }}" required>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <select id="establishment_id" name="establishment_id" class="form-control selectpicker"
                for="for_$establishment">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" id="program" name="program"
                {{ $request->get('program') ? 'value=' . $request->get('program') : '' }}>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" id="for_notas" name="notes"
                {{ $request->get('notes') ? 'value=' . $request->get('notes') : '' }}>
    ...
    <script type="text/javascript">
        ...
        var tableToExcel = (function() {
            var uri = 'data:application/vnd.ms-excel;base64,',
                template =
                '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40"><head><meta http-equiv="Content-Type" content="text/html;charset=utf-8"></head><body><table>{table}</table></body></html>',
                base64 = function(s) {
