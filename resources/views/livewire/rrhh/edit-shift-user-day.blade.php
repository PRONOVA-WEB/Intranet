<div>
    @php
    $orgunitFilter = $shiftUserDay->shiftUser->user->organizational_unit_id;
    $turnFilter  = $shiftUserDay->shiftUser->shift_types_id;
    $turno = 'Abierto';
    ...
    <div class="form-row">
        <a href="{{ route('rrhh.shiftManag.index',['orgunitFilter'=>$orgunitFilter,'turnFilter'=>$turnFilter,'monthYearFilter'=>$monthYearFilter]) }}" type="button"  class="btn btn-secondary mr-3">Volver</a>
        @if (!isset($shiftUserDay->shift_close_id))
